  ...
  return (
    <div>
      ...
      id="services" className="w-full px-[12%] py-10 scroll-mt-20">
        ...
        className="text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam porro consequuntur quasi labore accusantium esse. Reiciendis ratione repudiandae tenetur qui?</motion.p>
        <motion.div
           initial={{opacity:0}}
           whileInView={{opacity:1}}
           transition={{delay:0.1,duration:0.5}}
